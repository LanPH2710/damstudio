            ...
            <div class="login-container">
                ...
                <form action="loginbyaccount" method="post" class="login-form">
                    <div class="social-login">
                        <a href="https://accounts.google.com/o/oauth2/v2/auth?scope=openid%20email%20profile&redirect_uri=http://www.damstudio.store/loginbygoogle&response_type=code&client_id=39567511414-g806rgl6qc53stht3sr3sseav6oicv1m.apps.googleusercontent.com&access_type=offline&prompt=consent" 
                           class="google-btn">
